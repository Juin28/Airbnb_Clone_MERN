export default function Perks({selected, onChange}) {
    ...
    return (
        <>
            ...
            <label className="border p-4 rounded-2xl flex items-center gap-1 cursor-pointer">
                <input type="checkbox" checked={selected.includes("pet-friendly")} name="pet-friendly" onChange={handleCbClick} />
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-5" >
            ...
            <label className="border p-4 rounded-2xl flex items-center gap-1 cursor-pointer">
                <input type="checkbox" checked={selected.includes("fingerprint-lock")} name="fingerprint-lock" onChange={handleCbClick} />
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-5">
